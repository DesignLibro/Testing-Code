...
'''
@Author       : lucky.wang
@Date         : 2024/10/3 12:01
@File         : PLAF203_Night_Vision_Switching.py
...
if __name__ == '__main__':
    ...
    logger.info('黑白夜视专项测试开始...')

    gpio_port = int(input("请输入对应掉电的GPIO口（默认为17）:---- ").strip())
    ...
    # if down_timer is not None and down_timer != 40:
