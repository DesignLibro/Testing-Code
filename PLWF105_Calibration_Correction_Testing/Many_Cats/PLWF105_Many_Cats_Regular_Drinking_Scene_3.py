...
'''
@Author       : neil.fan
@Date         : 2024/09/19 10:35
@File         : PLWF105_Many_Cats_Regular_Drinking_Scene_3.py
@Interpreter Version: python 3.12
@Description: 场景3：A猫，B猫，60S稳定规律饮水，每秒饮水0.4ml，饮水10S，停顿10S后，继续饮水，每秒饮水0.4ml，饮水10S，30S饮水数据上报；
'''
...
class MQTTProducer(object):
    ...
    def publish(self, client):
        ...
        # while True:
        self.getClient_id()
        self.weight_percent_decrement = 0.4
