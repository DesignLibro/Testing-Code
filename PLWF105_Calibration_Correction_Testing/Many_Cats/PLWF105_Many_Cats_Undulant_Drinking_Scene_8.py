...
@File         : PLWF105_Many_Cats_Undulant_Drinking_Scene_8.py
@Interpreter Version: python 3.12
@Description: 场景8：多猫饮水美化数据上报，多猫1S饮水30ml，数据上报；
'''
...
class MQTTProducer(object):
    ...
    def publish(self, client):
        ...
        self.weight_percent_decrement2 = 30
        ...
        for i in range(1, 2):
            ...
            for c in range(1, 2):
                ...
                self.previous_weight_percent -= (1 * self.weight_percent_decrement2)
            time.sleep(15)
