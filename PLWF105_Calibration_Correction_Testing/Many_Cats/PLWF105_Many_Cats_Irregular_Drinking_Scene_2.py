...
'''
@Author       : neil.fan
@Date         : 2024/09/19 12:05
@File         : PLWF105_Many_Cats_Irregular_Drinking_Scene_2.py
@Interpreter Version: python 3.12
@Description: 场景2：A猫，B猫，60S不规律饮水，A猫，第一次饮水10S，每秒饮水1ml，停顿40S，B猫第二次饮水10S，每秒饮水1.5ml，共计饮水25ml饮水数据上报；
'''
...
class MQTTProducer(object):
    ...
    def publish(self, client):
        ...
        self.weight_percent_decrement2 = 1.5
        ...
        for i in range(1, 2):
            ...
            for b in range(1, 2):
                ...
                self.previous_weight_percent -= (10 * self.weight_percent_decrement1)
            time.sleep(10)
            ...
            for b in range(1, 2):
                ...
                self.previous_weight_percent -= (10 * self.weight_percent_decrement2)
