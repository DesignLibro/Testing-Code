...
@File         : PLWF105_Many_Cats_Irregular_Drinking_Scene_3.py
@Interpreter Version: python 3.12
@Description: 场景3：A猫，B猫，30S不规律饮水，A猫第一次饮水15S，每秒饮水0.4ml，B猫第一饮水15S，每秒饮水0.2ml，饮水30ml饮水数据上报；
'''
...
class MQTTProducer(object):
    ...
    def publish(self, client):
        ...
        # while True:
        self.getClient_id()
        self.weight_percent_decrement1 = 0.4
        self.weight_percent_decrement2 = 0.2
