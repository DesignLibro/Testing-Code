...
# @Author       : neil
# @Date         : 2024/09/19 14:05
# @File         : WF105饮水算法测试_多猫不规律饮水场景4.py4
# @Mark         : 场景4：A猫，B猫，30S不稳定规律饮水，A猫第一次饮水15S，每秒饮水0.2ml，B猫第一饮水15S，每秒饮水0.4ml，饮水30ml饮水数据上报
# @TechnicalBarriers:
# @KnowledgePoints:
...
@Author       : neil.fan
@Date         : 2024/09/19 14:05
@File         : PLWF105_Many_Cats_Irregular_Drinking_Scene_4.py
@Interpreter Version: python 3.12
@Description: 场景4：A猫，B猫，30S不规律饮水，A猫第一次饮水15S，每秒饮水0.2ml，B猫第一饮水15S，每秒饮水0.4ml，饮水30ml饮水数据上报；
'''
...
class MQTTProducer(object):
    ...
    def publish(self, client):
        ...
        # while True:
        self.getClient_id()
        self.weight_percent_decrement1 = 0.2
        self.weight_percent_decrement2 = 0.4
        self.time_increment = 1000
        self.start_weight_percent = 3000
        ...
        for i in range(1, 2):
            ...
            for b in range(1, 2):
                ...
                self.msg2 = json.dumps(
                    {
                        ...
                        "content": [
                            ...
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - self.weight_percent_decrement1 * 6,
                                                1),
                                "ts": current_time + self.time_increment * 6,
                                "rfid": ""
                            },
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - self.weight_percent_decrement1 * 7,
                                                1),
                                "ts": current_time + self.time_increment * 7,
                                "rfid": ""
                            },
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - self.weight_percent_decrement1 * 8,
                                                1),
                                "ts": current_time + self.time_increment * 8,
                                "rfid": ""
                            },
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - self.weight_percent_decrement1 * 9,
                                                1),
                                "ts": current_time + self.time_increment * 9,
                                "rfid": ""
                            },
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - self.weight_percent_decrement1 * 10,
                                                1),
                                "ts": current_time + self.time_increment * 10,
                                "rfid": ""
                            },
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - self.weight_percent_decrement1 * 11,
                                                1),
                                "ts": current_time + self.time_increment * 10,
                                "rfid": ""
                            },
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - self.weight_percent_decrement1 * 12,
                                                1),
                                "ts": current_time + self.time_increment * 10,
                                "rfid": ""
                            },
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - self.weight_percent_decrement1 * 13,
                                                1),
                                "ts": current_time + self.time_increment * 10,
                                "rfid": ""
                            },
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - self.weight_percent_decrement1 * 14,
                                                1),
                                "ts": current_time + self.time_increment * 10,
                                "rfid": ""
                            },
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - self.weight_percent_decrement1 * 15,
                                                1),
                                "ts": current_time + self.time_increment * 10,
                                "rfid": ""
                            },
                ...
                self.previous_weight_percent -= (15 * self.weight_percent_decrement1)
            ...
            for b in range(1, 2):
                ...
                self.msg2 = json.dumps(
                    {
                        ...
                        "content": [
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - self.weight_percent_decrement2 * 1,
                                                1),
                                "ts": current_time + self.time_increment * 1,
                                "rfid": ""
                            },
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - self.weight_percent_decrement2 * 2,
                                                1),
                                "ts": current_time + self.time_increment * 2,
                                "rfid": ""
                            },
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - self.weight_percent_decrement2 * 3,
                                                1),
                                "ts": current_time + self.time_increment * 3,
                                "rfid": ""
                            },
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - self.weight_percent_decrement2 * 4,
                                                1),
                                "ts": current_time + self.time_increment * 4,
                                "rfid": ""
                            },
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - self.weight_percent_decrement2 * 5,
                                                1),
                                "ts": current_time + self.time_increment * 5,
                                "rfid": ""
                            },
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - self.weight_percent_decrement2 * 6,
                                                1),
                                "ts": current_time + self.time_increment * 6,
                                "rfid": ""
                            },
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - self.weight_percent_decrement2 * 7,
                                                1),
                                "ts": current_time + self.time_increment * 7,
                                "rfid": ""
                            },
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - self.weight_percent_decrement2 * 8,
                                                1),
                                "ts": current_time + self.time_increment * 8,
                                "rfid": ""
                            },
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - self.weight_percent_decrement2 * 9,
                                                1),
                                "ts": current_time + self.time_increment * 9,
                                "rfid": ""
                            },
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - self.weight_percent_decrement2 * 10,
                                                1),
                                "ts": current_time + self.time_increment * 10,
                                "rfid": ""
                            },
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - self.weight_percent_decrement2 * 11,
                                                1),
                                "ts": current_time + self.time_increment * 10,
                                "rfid": ""
                            },
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - self.weight_percent_decrement2 * 12,
                                                1),
                                "ts": current_time + self.time_increment * 10,
                                "rfid": ""
                            },
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - self.weight_percent_decrement2 * 13,
                                                1),
                                "ts": current_time + self.time_increment * 10,
                                "rfid": ""
                            },
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - self.weight_percent_decrement2 * 14,
                                                1),
                                "ts": current_time + self.time_increment * 10,
                                "rfid": ""
                            },
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - self.weight_percent_decrement2 * 15,
                                                1),
                                "ts": current_time + self.time_increment * 10,
                                "rfid": ""
                            },
                ...
                self.previous_weight_percent -= (15 * self.weight_percent_decrement2)
