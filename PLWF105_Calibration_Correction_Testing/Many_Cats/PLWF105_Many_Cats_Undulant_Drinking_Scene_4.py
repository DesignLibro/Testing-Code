...
@File         : PLWF105_Many_Cats_Undulant_Drinking_Scene_4.py
@Interpreter Version: python 3.12
@Description: 场景4：多猫饮水15S，A猫，饮水15S，每秒0.2ml，水位波动，上下浮动3ml,持续10S，水量稳定后，B猫，继续饮水15S，每秒0.3ml,饮水数据上报；
'''
...
class MQTTProducer(object):
    ...
    def publish(self, client):
        ...
        self.weight_percent_decrement2 = 0.3
        self.time_increment = 1000
        self.start_weight_percent = 4500
                ...
                self.msg2 = json.dumps(
                    {
                        ...
                        "content": [
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent + 3,
                                                1),
                                "ts": current_time + self.time_increment * 1,
                                "rfid": ""
                            },
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent,
                                                1),
                                "ts": current_time + self.time_increment * 2,
                                "rfid": ""
                            },
