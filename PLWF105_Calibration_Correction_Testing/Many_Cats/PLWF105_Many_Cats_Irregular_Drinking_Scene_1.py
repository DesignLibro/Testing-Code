...
@File         : PLWF105_Many_Cats_Irregular_Drinking_Scene_1.py
@Interpreter Version: python 3.12
@Description: 场景1：A猫，B猫，30S不规律饮水，每秒饮水1ml，饮水30ml饮水数据上报；
'''
...
class MQTTProducer(object):
    ...
    def publish(self, client):
        ...
        # while True:
        self.getClient_id()
        self.weight_percent_decrement1 = 1.5
        self.weight_percent_decrement2 = 1.6
