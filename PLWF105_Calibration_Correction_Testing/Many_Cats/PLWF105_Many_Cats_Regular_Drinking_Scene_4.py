...
'''
@Author       : neil.fan
@Date         : 2024/09/19 10:19
@File         : PLWF105_Many_Cats_Regular_Drinking_Scene_4.py
@Interpreter Version: python 3.12
@Description: 场景4：A猫，B猫，30S稳定规律饮水，每秒饮水1ml，饮水30ml饮水数据上报；
'''
...
class MQTTProducer(object):
    ...
    def publish(self, client):
        ...
        # while True:
        self.getClient_id()
        self.weight_percent_decrement = 3.1
