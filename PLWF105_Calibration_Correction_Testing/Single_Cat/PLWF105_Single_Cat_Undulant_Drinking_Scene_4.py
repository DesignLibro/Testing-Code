...
# @File         : WF105饮水算法测试_单猫波动饮水场景4.py
# @Mark         : 场景4：单猫饮水美化数据上报，单猫饮水时长大于30S，前10S饮水0.5ml,停顿15S，后10S饮水0.5ml，35S水量上报1ml
# @TechnicalBarriers:
# @KnowledgePoints:
...
@Author       : neil.fan
@Date         : 2024/09/18 14:47
@File         : PLWF105_Single_Cat_Undulant_Drinking_Scene_4.py
@Interpreter Version: python 3.12
@Description: 场景4：单猫饮水美化数据上报，单猫饮水时长大于30S，前10S饮水0.5ml,停顿15S，后10S饮水0.5ml，35S水量上报1ml；
'''
...
class MQTTProducer(object):
    ...
    def publish(self, client):
        ...
        self.weight_percent_decrement2 = 0.05
