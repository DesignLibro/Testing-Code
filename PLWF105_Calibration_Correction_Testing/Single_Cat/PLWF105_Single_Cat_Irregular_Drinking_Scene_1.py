...
@File         : PLWF105_Single_Cat_Irregular_Drinking_Scene_1.py
@Interpreter Version: python 3.12
@Description: 场景1：A猫，第一次15S饮水15ml，每秒饮水1ml，停顿10S，第二次15S饮水16.5ml，每秒饮水1.1ml,合计31ml上报；
'''
...
class MQTTProducer(object):
    ...
    def publish(self, client):
        ...
        # while True:
        self.getClient_id()
        self.weight_percent_decrement1 = 1
        self.weight_percent_decrement2 = 1.1
