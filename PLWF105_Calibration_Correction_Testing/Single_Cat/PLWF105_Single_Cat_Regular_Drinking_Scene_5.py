...
'''
@Author       : neil.fan
@Date         : 2024/09/18 14:12
@File         : PLWF105_Single_Cat_Regular_Drinking_Scene_5.py
@Interpreter Version: python 3.12
@Description: 场景5：A猫，30S内稳定规律饮水，每秒饮水1.5ml，30S饮水45ml上报；
'''
...
class MQTTProducer(object):
    ...
    def publish(self, client):
        ...
        # while True:
        self.getClient_id()
        self.weight_percent_decrement = 3
        self.time_increment = 1000
        self.start_weight_percent = 10000
