...
# @Author       : neil
# @Date         : 2024/09/11 11:30
# @File         : WF305饮水算法测试_单猫场景16.py
# @Mark         : 场景16：A猫饮水，识别RFID15次，每秒饮水0.1ml，共饮水1ml，数据美化上报
# @TechnicalBarriers:
# @KnowledgePoints:
...
class MQTTProducer(object):
    ...
    def __init__(self):
        ...
        logger.add(rf'../log/{self.logFilename}测试环境出粮上报逻辑MQTT生产者.log', rotation='50MB', encoding='utf-8',
                   enqueue=True)
        self.broker = 'demo-svc.dl-aiot.com'  # 测试环境mqtt代理服务器地址
        self.port = 1883
        self.deviceSN = 'WF02013576881829L'
        self.deviceRfid_A = '130008751259810'
        # self.deviceRfid_B = '130036108105613'
        self.weightPercent = 80
        self.keepalive = 60  # 与代理通信之间允许的最长时间段（以秒为单位）
        # self.topic = "dl/PLAF203/AF03013651165ERL7/device/event/post"  # 消息主题
        # self.topic = "dl/PLAF107/AF02013A661079B2S/device/event/post"  # 消息主题
        # self.topic = "dl/PLAF301/AF060132C7612126V/device/event/post"  # 消息主题
        self.topic = f"dl/PLWF305/{self.deviceSN}/device/event/post"  # 消息主题
        # self.topic = "dl/PLAF203/AF0301364488211AR/device/event/post"  # 消息主题
        # self.topic = "dl/PLAF103/AF01013566891008M/device/event/post"  # 消息主题
        # self.topic = "dl/PLAF108/AF040131AF6E351G2/device/event/post"  # 消息主题
        self.qos = 1
        self.username = 'T7NQEH8Z4XOVS4YT'
        self.passwd = 'NINH41RZDN89OI68796SF14SB9GOF2GL'
        self.client_id = self.deviceSN
    ...
    def publish1(self, client):
        '''发布消息'''

        # while True:
        self.getClient_id()
        self.weight_percent_decrement = 0.1
                    ...
                    self.msg6 = json.dumps(
                        {
                            ...
                            "rssi": -46,
                            "wifiType": 1,
                            "msgId": f"{self.deviceSN}{current_time}",
                            "ts": current_time
                        }
                    )
