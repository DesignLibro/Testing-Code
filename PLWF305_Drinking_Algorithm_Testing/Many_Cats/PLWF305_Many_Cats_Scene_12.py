...
@File         : PLWF305_Many_Cats_Scene_12.py
@Interpreter Version: python 3.12
@Description: 场景12：A猫，B猫轮流饮水30S，A猫饮水15S，RFID识别15次，每秒饮水0.2ml，B猫饮水15S，RFID识别15次，每秒饮水0.2ml，饮水期间，水量上下起伏波动5ml,数据上报；
'''
    ...
    def publish(self, client):
        ...
        for i in range(1, 2):
            ...
            for b in range(1, 2):
                ...
                self.previous_weight_percent += (self.weight_percent_decrement + 5)
                self.previous_weight_percent -= (self.weight_percent_decrement - 5)
                ...
                self.msg3 = json.dumps(
                    {
                        ...
                        "content": [
                            ...
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent + 5 - self.weight_percent_decrement * 2,
                                                1),
                                "ts": current_time + self.time_increment * 2,
                                "rfid": f"{self.RFID_SN_B}"
                            },
                            ...
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - 5 - self.weight_percent_decrement * 4,
                                                1),
                                "ts": current_time + self.time_increment * 4,
                                "rfid": f"{self.RFID_SN_B}"
                            },
                            ...
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent + 5 - self.weight_percent_decrement * 6,
                                                1),
                                "ts": current_time + self.time_increment * 6,
                                "rfid": f"{self.RFID_SN_B}"
                            },
                            ...
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - 5 - self.weight_percent_decrement * 8,
                                                1),
                                "ts": current_time + self.time_increment * 8,
                                "rfid": f"{self.RFID_SN_B}"
                            },
                            ...
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent + 5 - self.weight_percent_decrement * 10,
                                                1),
                                "ts": current_time + self.time_increment * 10,
                                "rfid": f"{self.RFID_SN_B}"
                            },
                            ...
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent - 5 - self.weight_percent_decrement * 12,
                                                1),
                                "ts": current_time + self.time_increment * 12,
                                "rfid": f"{self.RFID_SN_B}"
                            },
                            ...
                            {
                                "weightPercent": round((int(self.start_weight_percent / 3000 * 100)), -1),
                                "weight": round(self.previous_weight_percent + 5 - self.weight_percent_decrement * 14,
                                                1),
                                "ts": current_time + self.time_increment * 14,
                                "rfid": f"{self.RFID_SN_B}"
                            },
