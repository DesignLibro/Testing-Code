...
@File         : PLWF305_Many_Cats_Scene_5.py
@Interpreter Version: python 3.12
@Description: 场景5：A猫，B猫共同饮水30S，前15S，RFID识别15次，A猫识别10次，B猫识别5次，每秒饮水0.5ml,后15S，RFID无法识别A猫，B猫信息，但饮水正常A猫，B猫共同饮水15S，每秒饮水0.5ml，数据上报；
'''
