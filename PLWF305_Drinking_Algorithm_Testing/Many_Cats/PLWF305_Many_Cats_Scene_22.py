...
@File         : PLWF305_Many_Cats_Scene_22.py
@Interpreter Version: python 3.12
@Description: 场景22：A猫，B猫分别饮水30S，识别RFID30次，A猫识别30次，B猫识别30次，间隔4分钟，A猫，B猫分别上报事件；
'''
    ...
    def publish(self, client):
        ...
        for i in range(1, 2):
            ...
            for c in range(1, 16):
                ...
                result4 = client.publish(self.topic, self.msg13)
                status4 = result4[0]
                if status4 == 0:
            ...
            for d in range(1, 3):
                ...
                self.previous_weight_percent -= (10 * self.weight_percent_decrement)
