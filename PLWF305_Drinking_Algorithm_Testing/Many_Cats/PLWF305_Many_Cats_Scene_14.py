...
'''
@Author       : neil.fan
@Date         : 2024/09/12 18:29
@File         : PLWF305_Many_Cats_Scene_14.py
@Interpreter Version: python 3.12
@Description: 场景14：A猫，B猫共同饮水30S，A，B猫饮水15S，A猫RFID识别10次，每秒饮水0.3ml，B猫RFID识别5次，每秒饮水0.3ml，饮水结束后，水位波动上下3ml，波动15S后，水量稳定，稳定后，A，B猫继续饮水15S，A猫RFID识别10次,B猫RFID识别5次，每秒饮水0.3ml，数据上报；
'''
    ...
    def publish(self, client):
        ...
        for i in range(1, 2):
            ...
            for c in range(1, 2):
                ...
                self.previous_weight_percent += (self.previous_weight_percent + 3)
                self.previous_weight_percent -= (self.previous_weight_percent - 3)
